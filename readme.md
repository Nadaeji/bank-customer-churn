...
| **분석 변수** | **핵심 인사이트** | **추가 해석** |
| --- | --- | --- |
| **성별 (Gender)** | 여성 고객의 이탈률이 남성보다 다소 높음 (17.4% vs 14.6%) | 단독 변수로는 예측력 약함
**다변량 분석 필요** |
| **교육 수준 (Education_Level)** | 고학력자일수록 이탈률 증가 (박사: 21.1%) | **지적 수준 높은 고객일수록 이탈 민감도** ↑ |
| **결혼 상태 (Marital_Status)** | 기혼 고객의 이탈률 가장 낮음 | **안정된 생활 기반** 고객은 **유지 가능성 높음** |
| **소득 수준 (Income_Category)** | 중산층($60K–$80K)의 이탈률 가장 낮음 (13.5%) | **고·저소득층보다 중산층**이 **안정적인 고객군** |
| **카드 등급 (Card_Category)** | Platinum 카드 고객 이탈률 가장 높음 (단, 표본 수 적음) | 등급이 높다고 **충성도 높은 건 아님** → **맞춤 관리 필요** |
</aside>
...
- `Total_Trans_Amt`, `Total_Trans_Ct`, `Total_Amt_Chng_Q4_Q1`, `Total_Ct_Chng_Q4_Q1` 컬럼과 타겟인 Attrition_Flag를 비교했을 때, 네 개의 독립변수 모두 값이 적을 수록 이탈율이 높다는 것을 알 수 있었다.
...
- 카드 종류와, 신용카드 한도에 따른 이탈율 분석
    ...
    0       Blue     매우 낮음  0.089744
    1       Blue        낮음  0.217778
    2       Blue        보통  0.181683
    3       Blue        높음  0.167883
    4       Blue     매우 높음  0.143253
    5     Silver        보통  1.000000
    6     Silver        높음  0.132075
    7     Silver     매우 높음  0.149554
    8       Gold        보통  0.000000
    9       Gold     매우 높음  0.185841
